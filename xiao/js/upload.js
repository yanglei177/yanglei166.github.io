    ...
    $.fn.UploadImg = function(o){
        ...
        this.change(function(){
            ...
            if ($(".img_box li").length >= o.pictureCount) {
                ...
                o.before(blob,fileName);
                $(".loading_boxdpic").show();
                _compress(blob,file);
                this.value='';
            }
        });
        ...
        function checkSize(file) {
            var filemaxsize = 1024 * o.mixsize; //2M 
...
function checkType(type) {
    ...
    if (isnext == 0) {
        ...
        function _ajaximg(base64,type,file){
            $.post(o.url,{base64:base64,type:type,pictureName:sendfileName},function(res){
                var res = res;
                o.success(res);
                $(".loading_boxdpic").hide();
            });
